  ...
  <div class="position_content" id="page_position_content">
    ...
    <div class="clearfix colelem" id="pu86"><!-- group -->
      <div class="grpelem" id="u86"><!-- custom html -->
        <form name="result1" method="get" action="/signs/result" id="form1">
          <input type=hidden name="type" value="1">
          <input type="submit" name="submit" value="1 сеть">
        </form>
        <form name="result2" method="get" action="/signs/result" id="form2">
          <input type=hidden name="type" value="2">
          <input type="submit" name="submit" value="2 сеть">
        </form>
        <form name="result3" method="get" action="/signs/result" id="form3">
    ...
    <div class="clearfix colelem" id="pu88"><!-- group -->
      ...
      <div class="clip_frame grpelem" id="u112"><!-- image -->
        <img class="block" id="u112_img" src="/images/svet.jpg" alt="" width="68" height="61"/>
      </div>
      <div class="clip_frame grpelem" id="u118"><!-- image -->
        <img class="block" id="u118_img" src="/images/pravo.png" alt="" width="59" height="59"/>
      </div>
    </div>
